...
Future init() async {
  ...
  getItInstance.registerFactory(()=> LanguageCubit(getPreferredLanguage: getItInstance(), updateLanguage: getItInstance()));
  ...
  getItInstance.registerFactory(() => ThemeCubit(getPreferredTheme: getItInstance(),updateTheme: getItInstance()));
}
